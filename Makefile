...
test-browser:
	KPRESS_REQUIRE_BROWSER=1 $(UV_RUN) --extra optimize --extra pdf pytest tests/test_playwright_math_loading.py tests/test_playwright_math_text_face.py tests/test_playwright_sans_math_face.py tests/test_playwright_list_marker.py tests/test_playwright_mono_face.py tests/test_playwright_print_pdf_fonts.py tests/test_playwright_history.py
