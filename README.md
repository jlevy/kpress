...
KPress `0.3.1` is an alpha for developers evaluating it in real projects.
...
KPress `0.3.1` supports macOS and Linux; native Windows support is tracked for a later
alpha (`kpr-isp2`).
...
Truly self-contained single-file and verified offline output are not part of `0.3.1`.
